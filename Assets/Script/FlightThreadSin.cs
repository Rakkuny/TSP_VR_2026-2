...
public class FlightThreadSin : MonoBehaviour {
    ...
    public void SimulateTurbulence(float time) {
        ...
        lock(filepath) 
        {
            ...
            //BLOQUEO de Escritura del archivo
        ...
        write = true; //si llega aqui, quiere decir que ya escrubio el archivo y salio del lock
    }
    ...
    void TryReadFile() {
        try 
        {
            lock(fileLock)
            {
                ...
                {
                    Debug.LogError("Ocurrio un problema"); //si leemos esto es que es error de codigo y algo esta mal jajaja
                }
            }     
        } 
